if(WIN32)
  # Accept NDI_SDK_DIR as either a cmake cache variable (-DNDI_SDK_DIR=...)
  # or an environment variable; cache it so reconfigures don't lose it.
  if(NOT NDI_SDK_DIR AND DEFINED ENV{NDI_SDK_DIR})
    set(NDI_SDK_DIR "$ENV{NDI_SDK_DIR}" CACHE PATH "Path to the Windows NDI SDK")
  endif()
  if(NDI_SDK_DIR)
    set(NDI_FOUND TRUE)
